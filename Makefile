...
test_FML: a.out ${TEST_FILES}
	@$(foreach test_file, $(TEST_FILES), /bin/echo -e -n "\033[0;31mParsing $(test_file) ${OUTPUT_REDIR}\033[0m" && ./a.out "$(test_file)" ${OUTPUT_REDIR} && /bin/echo -e "\033[0;32m   ->   Passed!\033[0m")
